...
#               'W D4', 'w E3', 'w D2']
        ...
        board_reg_str=str(board.create_board_register(utils.Color.WHITE))
        ...
        logits = cnn.inference(data,boardsize,num_channels)
        ...
        with tf.Session() as sess:
            ...
            saver.restore(sess, "cnn_train/model.ckpt-30000")
