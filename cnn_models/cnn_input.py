...
def inputs(eval_data, data_dir, batch_size, num_train_files, train_num_examples, test_num_examples, boardsize,
           num_channels):
    ...
    if not eval_data:
        ...
        #                for i in xrange(1, num_train_files + 1)]
        print('filenames:{} in cnn_input.distorded_inputs() not eval data'.format(filenames))
        ...
        print('filenames:{} in cnn_input.distorded_inputs() using eval data'.format(filenames))
